...
import com.integrate.ssm.model.DepartmentCriteria.Criteria;
import com.integrate.ssm.model.DepartmentCriteria.Criterion;
...
public class DepartmentSqlProvider {
    ...
    public String countByExample(DepartmentCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("tbl_dept");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(DepartmentCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("tbl_dept");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String selectByExample(DepartmentCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        DepartmentCriteria example = (DepartmentCriteria) parameter.get("example");
    ...
    protected void applyWhere(SQL sql, DepartmentCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
